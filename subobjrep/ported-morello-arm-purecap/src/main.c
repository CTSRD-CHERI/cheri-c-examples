...
struct rte_lpm6 {
  ...
  //use _Alignas() built-in to force alignment to what warning says..
  _Alignas(131072) struct rte_lpm6_tbl_entry tbl24[RTE_LPM6_TBL24_NUM_ENTRIES]; //__attribute__((aligned(131072)))
  int a;
  int b;
} ;
